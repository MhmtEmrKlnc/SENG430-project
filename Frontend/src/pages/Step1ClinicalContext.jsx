...
export default function Step1ClinicalContext({ domain, onNext }) {
  ...
  return (
    <div className="step-container">
      <StepHeader
        ...
        description={<>Before we look at any data, we define the clinical problem. In <strong>{domain.name}</strong>, we want to solve: {domain.title.toLowerCase()}.</>}
        onNext={onNext}
      />
        ...
        <div>
          <div className="sidebar-section">
            ...
            <div className="scenario-block">
              ...
              <div className="scenario-value" style={{ fontSize: '1.125rem' }}>{domain.name}</div>
            </div>

            <div className="scenario-block">
              <div className="scenario-label" style={{ fontWeight: 600, color: '#0F172A' }}>Clinical Target</div>
              <div className="question-box">
                Target Variable: <strong>{domain.targetVariable}</strong><br/>
                {domain.title}
              </div>
            </div>
