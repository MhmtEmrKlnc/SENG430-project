...
DOMAIN_META: Dict[str, Dict[str, Any]] = {
    # ── 1. Cardiology – Heart Failure (UCI Heart Failure Clinical Records) ──
    "cardiology": {
        "file": "cardiology.csv",
    ...
    # ── 2. Nephrology – CKD (UCI CKD Dataset) ──
    "nephrology": {
        "file": "nephrology.csv",
    ...
    # ── 3. Oncology – Breast Cancer (Wisconsin) ──
    "breast_cancer": {
    ...
    # ── 4. Neurology – Parkinson's (UCI Parkinson's) ──
    "parkinsons": {
        "file": "parkinsons.csv",
        "target": "status",
        "suggested_features": [
    ...
    # ── 5. Endocrinology – Diabetes (Pima Indians) ──
    "diabetes": {
        "file": "diabetes.csv",
        "target": "outcome",
        "suggested_features": [
    ...
    # ── 6. Hepatology – Liver Disease (Indian Liver Patient) ──
    "liver": {
        "file": "liver.csv",
    ...
    # ── 7. Cardiology – Stroke (Kaggle Stroke) ──
    "stroke": {
        "file": "stroke.csv",
        "target": "stroke",
        "suggested_features": [
    ...
    # ── 8. Mental Health (Kaggle Depression/Anxiety) ──
    "mental_health": {
        "file": "mental_health.csv",
        "target": "crisis_flag",
        "suggested_features": [
            "phq9_score", "gad7_score", "sleep_hours",
            "social_support", "prior_episodes", "medication_adherence",
        ],
    },
    # ── 9. Pulmonology – COPD (synthetic) ──
    "pulmonology": {
        "file": "pulmonology.csv",
        "target": "exacerbation",
        "suggested_features": [
            "fev1_pct", "fvc_pct", "exacerbations_prev_year",
            "mrc_dyspnoea_score", "sao2_resting",
        ],
    },
    # ── 10. Haematology – Anaemia binary (CBC dataset) ──
    "haematology": {
        "file": "haematology.csv",
        "target": "anaemia",
        "suggested_features": [
            "haemoglobin", "rbc_count", "mcv", "mchc", "mch", "age",
        ],
    },
    # ── 11. Dermatology – Skin Lesion (synthetic) ──
    "dermatology": {
        "file": "dermatology.csv",
        "target": "lesion_class",
        "suggested_features": [
            "lesion_area_mm2", "border_irregularity", "color_variation",
            "asymmetry_score", "elevation",
        ],
    },
    # ── 12. Ophthalmology – Diabetic Retinopathy (UCI Retinopathy Debrecen) ──
    "ophthalmology": {
        "file": "ophthalmology.csv",
        "target": "retinopathy",
        "suggested_features": [
            "diabetes_duration", "hba1c", "microaneurysms",
            "hard_exudates", "blood_pressure",
        ],
    },
    # ── 13. Orthopaedics – Spine (UCI Vertebral Column) ──
    "orthopaedics": {
        "file": "orthopaedics.csv",
        "target": "class",
        "suggested_features": [
    ...
    # ── 14. ICU – Sepsis (PhysioNet, aggregated per patient) ──
    "sepsis": {
        "file": "sepsis.csv",
        "target": "sepsis",
        "suggested_features": [
    ...
    # ── 15. Obstetrics – Fetal Health (UCI CTG) ──
    "fetal_health": {
    ...
    # ── 16. Cardiology – Arrhythmia (MIT-BIH) ──
    "arrhythmia": {
        "file": "arrhythmia.csv",
        "target": "arrhythmia_class",
        "suggested_features": [
            "heart_rate", "pr_interval", "qrs_duration",
            "qt_interval", "qrs_axis",
        ],
    },
    # ── 17. Oncology – Cervical Cancer (UCI) ──
    "cervical_cancer": {
        "file": "cervical_cancer.csv",
        "target": "biopsy",
        "suggested_features": [
            "age", "num_sexual_partners", "smokes_pack_years",
            "hormonal_contraceptives_years", "stds_count",
        ],
    },
    # ── 18. Endocrinology – Thyroid (UCI Thyroid Disease) ──
    "thyroid": {
        "file": "thyroid.csv",
    ...
    # ── 19. Haematology Advanced – Anaemia Types (CBC multiclass) ──
    "haematology_advanced": {
        "file": "haematology_advanced.csv",
        "target": "anaemia_type",
        "suggested_features": [
            "haemoglobin", "mcv", "mch", "mchc",
            "serum_ferritin", "b12_level",
        ],
    },
    # ── 20. Pharmacy – Diabetic Readmission (UCI 130-US Hospitals) ──
    "readmission": {
        "file": "readmission.csv",
        "target": "readmitted",
        "suggested_features": [
            "num_medications", "num_lab_procedures", "time_in_hospital",
            "number_diagnoses", "a1c_result", "age",
        ],
    },
}
